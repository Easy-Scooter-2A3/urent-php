...
<body class="bg-gray-100">
    ...
    <div class="m-2 flex flex-col md:flex-row w-11/12 border mx-auto justify-between">
            ...
            <div class="flex flex-col">
                ...
                <div class="mdc-form-field">
                    <div class="mdc-checkbox">
                        <input type="checkbox" class="mdc-checkbox__native-control" id="checkbox-{{ $attribute->id }}" />
                  ...
                  <table class="mdc-data-table__table">
                    ...
                    <tbody id="catalogue" class="mdc-data-table__content">
                      ...
                      <tr productattributeParent class="mdc-data-table__row">
                        <td class="mdc-data-table__cell flex">
                            ...
                            <div class="flex flex-col justify-around">
                                <ul class="list-disc mb-5">
                                    @isset($attributesList[$product->id])
                                        ...
                                        <li>{{ $attributes[$attribute]['name'] }}</li>
                                        @endforeach
                                    @endisset
                                </ul>
