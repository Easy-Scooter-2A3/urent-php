  ...
  <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div id="modal-edit-body" class="p-6 space-y-6 h-96 overflow-y-auto">
                          ...
                          <tr class="mdc-data-table__header-row">
                            ...
                            <th class="mdc-data-table__header-cell mdc-data-table__header-cell--checkbox" role="columnheader" scope="col">
                                <div class="mdc-checkbox mdc-data-table__header-row-checkbox mdc-checkbox--selected">
                                  <input id="checkbox-all-edit" type="checkbox" class="mdc-checkbox__native-control" aria-label="Toggle all rows"/>
                          ...
                          <tr productattributeParent class="mdc-data-table__row">
                            ...
                            <td class="mdc-data-table__cell mdc-data-table__cell--checkbox">
                                <div class="mdc-checkbox mdc-data-table__row-checkbox">
                                  <input productattribute-edit={{ $product->id }} type="checkbox" class="mdc-checkbox__native-control"/>
                                  <div class="mdc-checkbox__background">
                                    <svg class="mdc-checkbox__checkmark" viewBox="0 0 24 24">
                                      <path class="mdc-checkbox__checkmark-path" fill="none" d="M1.73,12.91 8.1,19.28 22.79,4.59" />
                                    </svg>
              ...
              <div id="usersList" class="flex flex-col justify-around">
